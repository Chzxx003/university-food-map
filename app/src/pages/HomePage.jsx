...
export default function HomePage() {
  ...
  return (
    <div className="pb-24 md:pb-8">
      {/* Desktop: centered container matching navbar max-w-7xl */}
      <div className="lg:max-w-7xl lg:mx-auto lg:px-6 lg:pt-5">
        <div className="lg:flex lg:gap-6 lg:items-start">

          {/* ── Left column: max width capped so cards don't stretch too wide ── */}
          <div className="lg:flex-1 lg:min-w-0 lg:max-w-[780px]">

            {/* Hero area: edge-to-edge on mobile, rounded card on desktop */}
            ...
            {/* Restaurant list */}
            <div className="px-4 lg:px-0 mt-3 pb-6 space-y-2">
              {loading ? (
          ...
          {/* ── Right column: map as glass card, sticky (desktop only) ── */}
          <div className="hidden lg:block flex-shrink-0 w-[380px]">
            <div className="sticky top-[84px]">
              ...
              {/* Map card body */}
              <div className="rounded-2xl overflow-hidden shadow-md" style={{ height: 'calc(100vh - 130px)' }}>
